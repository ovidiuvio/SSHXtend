...
// CLI WebSocket wrapper message with correlation ID for request-response pattern
type CliRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Id    string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` // Unique request ID for correlation
	// Types that are valid to be assigned to CliMessage:
	//
	//	*CliRequest_OpenSession
	//	*CliRequest_CloseSession
	//	*CliRequest_StartChannel
	//	*CliRequest_TerminalData
	//	*CliRequest_CreatedShell
	//	*CliRequest_ClosedShell
	//	*CliRequest_Pong
	//	*CliRequest_Error
	CliMessage    isCliRequest_CliMessage `protobuf_oneof:"cli_message"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CliRequest) Reset() {
	*x = CliRequest{}
	mi := &file_proto_sshx_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CliRequest) Descriptor() ([]byte, []int) {
	return file_proto_sshx_proto_rawDescGZIP(), []int{13}
}

func (x *CliRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *CliRequest) GetCliMessage() isCliRequest_CliMessage {
	if x != nil {
		return x.CliMessage
	}
	return nil
...
func (x *CliRequest) GetOpenSession() *OpenRequest {
	if x != nil {
		if x, ok := x.CliMessage.(*CliRequest_OpenSession); ok {
...
func (x *CliRequest) GetCloseSession() *CloseRequest {
	if x != nil {
		if x, ok := x.CliMessage.(*CliRequest_CloseSession); ok {
...
func (x *CliRequest) GetStartChannel() *ChannelStartRequest {
	if x != nil {
		if x, ok := x.CliMessage.(*CliRequest_StartChannel); ok {
...
func (x *CliRequest) GetTerminalData() *TerminalData {
	if x != nil {
		if x, ok := x.CliMessage.(*CliRequest_TerminalData); ok {
...
func (x *CliRequest) GetCreatedShell() *NewShell {
	if x != nil {
		if x, ok := x.CliMessage.(*CliRequest_CreatedShell); ok {
			return x.CreatedShell
		}
	}
	return nil
...
func (x *CliRequest) GetClosedShell() uint32 {
	if x != nil {
		if x, ok := x.CliMessage.(*CliRequest_ClosedShell); ok {
			return x.ClosedShell
		}
	}
	return 0
...
func (x *CliRequest) GetPong() uint64 {
	if x != nil {
		if x, ok := x.CliMessage.(*CliRequest_Pong); ok {
			return x.Pong
		}
	}
	return 0
...
func (x *CliRequest) GetError() string {
	if x != nil {
		if x, ok := x.CliMessage.(*CliRequest_Error); ok {
			return x.Error
		}
	}
	return ""
...
type isCliRequest_CliMessage interface {
	isCliRequest_CliMessage()
}

type CliRequest_OpenSession struct {
	OpenSession *OpenRequest `protobuf:"bytes,2,opt,name=open_session,json=openSession,proto3,oneof"`
}

type CliRequest_CloseSession struct {
	CloseSession *CloseRequest `protobuf:"bytes,3,opt,name=close_session,json=closeSession,proto3,oneof"`
}

type CliRequest_StartChannel struct {
	StartChannel *ChannelStartRequest `protobuf:"bytes,4,opt,name=start_channel,json=startChannel,proto3,oneof"`
}

type CliRequest_TerminalData struct {
	TerminalData *TerminalData `protobuf:"bytes,5,opt,name=terminal_data,json=terminalData,proto3,oneof"`
}

type CliRequest_CreatedShell struct {
	CreatedShell *NewShell `protobuf:"bytes,6,opt,name=created_shell,json=createdShell,proto3,oneof"`
}

type CliRequest_ClosedShell struct {
	ClosedShell uint32 `protobuf:"varint,7,opt,name=closed_shell,json=closedShell,proto3,oneof"`
}

type CliRequest_Pong struct {
	Pong uint64 `protobuf:"fixed64,8,opt,name=pong,proto3,oneof"`
}

type CliRequest_Error struct {
	Error string `protobuf:"bytes,9,opt,name=error,proto3,oneof"`
}

func (*CliRequest_OpenSession) isCliRequest_CliMessage() {}

func (*CliRequest_CloseSession) isCliRequest_CliMessage() {}

func (*CliRequest_StartChannel) isCliRequest_CliMessage() {}

func (*CliRequest_TerminalData) isCliRequest_CliMessage() {}

func (*CliRequest_CreatedShell) isCliRequest_CliMessage() {}

func (*CliRequest_ClosedShell) isCliRequest_CliMessage() {}

func (*CliRequest_Pong) isCliRequest_CliMessage() {}

func (*CliRequest_Error) isCliRequest_CliMessage() {}

// CLI WebSocket response message with correlation ID
type CliResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Id    string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` // Request ID this response corresponds to
	// Types that are valid to be assigned to CliResponseMessage:
	//
	//	*CliResponse_OpenSession
	//	*CliResponse_CloseSession
	//	*CliResponse_StartChannel
	//	*CliResponse_TerminalInput
	//	*CliResponse_CreateShell
	//	*CliResponse_CloseShell
	//	*CliResponse_Sync
	//	*CliResponse_Resize
	//	*CliResponse_Ping
	//	*CliResponse_Error
	CliResponseMessage isCliResponse_CliResponseMessage `protobuf_oneof:"cli_response_message"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *CliResponse) Reset() {
	*x = CliResponse{}
	mi := &file_proto_sshx_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CliResponse) Descriptor() ([]byte, []int) {
	return file_proto_sshx_proto_rawDescGZIP(), []int{14}
}

func (x *CliResponse) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *CliResponse) GetCliResponseMessage() isCliResponse_CliResponseMessage {
	if x != nil {
		return x.CliResponseMessage
	}
	return nil
}

func (x *CliResponse) GetOpenSession() *OpenResponse {
	if x != nil {
		if x, ok := x.CliResponseMessage.(*CliResponse_OpenSession); ok {
			return x.OpenSession
		}
	}
	return nil
...
func (x *CliResponse) GetCloseSession() *CloseResponse {
	if x != nil {
		if x, ok := x.CliResponseMessage.(*CliResponse_CloseSession); ok {
			return x.CloseSession
		}
	}
	return nil
...
func (x *CliResponse) GetStartChannel() *ChannelStartResponse {
	if x != nil {
		if x, ok := x.CliResponseMessage.(*CliResponse_StartChannel); ok {
			return x.StartChannel
		}
	}
	return nil
...
func (x *CliResponse) GetTerminalInput() *TerminalInput {
	if x != nil {
		if x, ok := x.CliResponseMessage.(*CliResponse_TerminalInput); ok {
...
func (x *CliResponse) GetCreateShell() *NewShell {
	if x != nil {
		if x, ok := x.CliResponseMessage.(*CliResponse_CreateShell); ok {
			return x.CreateShell
		}
	}
	return nil
...
func (x *CliResponse) GetCloseShell() uint32 {
	if x != nil {
		if x, ok := x.CliResponseMessage.(*CliResponse_CloseShell); ok {
			return x.CloseShell
		}
	}
	return 0
...
func (x *CliResponse) GetSync() *SequenceNumbers {
	if x != nil {
		if x, ok := x.CliResponseMessage.(*CliResponse_Sync); ok {
			return x.Sync
		}
	}
	return nil
...
func (x *CliResponse) GetResize() *TerminalSize {
	if x != nil {
		if x, ok := x.CliResponseMessage.(*CliResponse_Resize); ok {
			return x.Resize
		}
	}
	return nil
...
func (x *CliResponse) GetPing() uint64 {
	if x != nil {
		if x, ok := x.CliResponseMessage.(*CliResponse_Ping); ok {
			return x.Ping
		}
	}
	return 0
...
func (x *CliResponse) GetError() string {
	if x != nil {
		if x, ok := x.CliResponseMessage.(*CliResponse_Error); ok {
			return x.Error
		}
	}
	return ""
...
type isCliResponse_CliResponseMessage interface {
	isCliResponse_CliResponseMessage()
}

type CliResponse_OpenSession struct {
	OpenSession *OpenResponse `protobuf:"bytes,2,opt,name=open_session,json=openSession,proto3,oneof"`
}

type CliResponse_CloseSession struct {
	CloseSession *CloseResponse `protobuf:"bytes,3,opt,name=close_session,json=closeSession,proto3,oneof"`
}

type CliResponse_StartChannel struct {
	StartChannel *ChannelStartResponse `protobuf:"bytes,4,opt,name=start_channel,json=startChannel,proto3,oneof"`
}

type CliResponse_TerminalInput struct {
	TerminalInput *TerminalInput `protobuf:"bytes,5,opt,name=terminal_input,json=terminalInput,proto3,oneof"`
}

type CliResponse_CreateShell struct {
	CreateShell *NewShell `protobuf:"bytes,6,opt,name=create_shell,json=createShell,proto3,oneof"`
}

type CliResponse_CloseShell struct {
	CloseShell uint32 `protobuf:"varint,7,opt,name=close_shell,json=closeShell,proto3,oneof"`
}

type CliResponse_Sync struct {
	Sync *SequenceNumbers `protobuf:"bytes,8,opt,name=sync,proto3,oneof"`
}

type CliResponse_Resize struct {
	Resize *TerminalSize `protobuf:"bytes,9,opt,name=resize,proto3,oneof"`
}

type CliResponse_Ping struct {
	Ping uint64 `protobuf:"fixed64,10,opt,name=ping,proto3,oneof"`
}
...
func (*CliResponse_OpenSession) isCliResponse_CliResponseMessage() {}

func (*CliResponse_CloseSession) isCliResponse_CliResponseMessage() {}

func (*CliResponse_StartChannel) isCliResponse_CliResponseMessage() {}

func (*CliResponse_TerminalInput) isCliResponse_CliResponseMessage() {}

func (*CliResponse_CreateShell) isCliResponse_CliResponseMessage() {}

func (*CliResponse_CloseShell) isCliResponse_CliResponseMessage() {}

func (*CliResponse_Sync) isCliResponse_CliResponseMessage() {}

func (*CliResponse_Resize) isCliResponse_CliResponseMessage() {}

func (*CliResponse_Ping) isCliResponse_CliResponseMessage() {}

func (*CliResponse_Error) isCliResponse_CliResponseMessage() {}

// Request to start bidirectional streaming for a session
type ChannelStartRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`   // Session name to start streaming for
	Token         string                 `protobuf:"bytes,2,opt,name=token,proto3" json:"token,omitempty"` // Authentication token for the session
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ChannelStartRequest) Reset() {
	*x = ChannelStartRequest{}
	mi := &file_proto_sshx_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ChannelStartRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChannelStartRequest) ProtoMessage() {}

func (x *ChannelStartRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_sshx_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChannelStartRequest.ProtoReflect.Descriptor instead.
func (*ChannelStartRequest) Descriptor() ([]byte, []int) {
	return file_proto_sshx_proto_rawDescGZIP(), []int{15}
}

func (x *ChannelStartRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ChannelStartRequest) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
// Response to channel start request
...
func (x *ChannelStartResponse) Reset() {
	*x = ChannelStartResponse{}
	mi := &file_proto_sshx_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ChannelStartResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChannelStartResponse) ProtoMessage() {}

func (x *ChannelStartResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_sshx_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChannelStartResponse.ProtoReflect.Descriptor instead.
func (*ChannelStartResponse) Descriptor() ([]byte, []int) {
	return file_proto_sshx_proto_rawDescGZIP(), []int{16}
}
...
const file_proto_sshx_proto_rawDesc = "" +
	...
	"\x04cols\x18\x03 \x01(\rR\x04cols\"\xaf\x01\n" +
	...
	"\x13write_password_hash\x18\x04 \x01(\fH\x00R\x11writePasswordHash\x88\x01\x01B\x16\n" +
	"\x14_write_password_hash\"J\n" +
	...
	"\fwinsize_cols\x18\t \x01(\rR\vwinsizeCols\"\xa5\x03\n" +
	"\n" +
	"CliRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x126\n" +
	"\fopen_session\x18\x02 \x01(\v2\x11.sshx.OpenRequestH\x00R\vopenSession\x129\n" +
	"\rclose_session\x18\x03 \x01(\v2\x12.sshx.CloseRequestH\x00R\fcloseSession\x12@\n" +
	"\rstart_channel\x18\x04 \x01(\v2\x19.sshx.ChannelStartRequestH\x00R\fstartChannel\x129\n" +
	"\rterminal_data\x18\x05 \x01(\v2\x12.sshx.TerminalDataH\x00R\fterminalData\x125\n" +
	"\rcreated_shell\x18\x06 \x01(\v2\x0e.sshx.NewShellH\x00R\fcreatedShell\x12#\n" +
	"\fclosed_shell\x18\a \x01(\rH\x00R\vclosedShell\x12\x14\n" +
	"\x04pong\x18\b \x01(\x06H\x00R\x04pong\x12\x16\n" +
	"\x05error\x18\t \x01(\tH\x00R\x05errorB\r\n" +
	"\vcli_message\"\x8c\x04\n" +
	"\vCliResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x127\n" +
	"\fopen_session\x18\x02 \x01(\v2\x12.sshx.OpenResponseH\x00R\vopenSession\x12:\n" +
	"\rclose_session\x18\x03 \x01(\v2\x13.sshx.CloseResponseH\x00R\fcloseSession\x12A\n" +
	"\rstart_channel\x18\x04 \x01(\v2\x1a.sshx.ChannelStartResponseH\x00R\fstartChannel\x12<\n" +
	"\x0eterminal_input\x18\x05 \x01(\v2\x13.sshx.TerminalInputH\x00R\rterminalInput\x123\n" +
	"\fcreate_shell\x18\x06 \x01(\v2\x0e.sshx.NewShellH\x00R\vcreateShell\x12!\n" +
	"\vclose_shell\x18\a \x01(\rH\x00R\n" +
	"closeShell\x12+\n" +
	"\x04sync\x18\b \x01(\v2\x15.sshx.SequenceNumbersH\x00R\x04sync\x12,\n" +
	"\x06resize\x18\t \x01(\v2\x12.sshx.TerminalSizeH\x00R\x06resize\x12\x14\n" +
	"\x04ping\x18\n" +
	" \x01(\x06H\x00R\x04ping\x12\x16\n" +
	"\x05error\x18\v \x01(\tH\x00R\x05errorB\x16\n" +
	"\x14cli_response_message\"?\n" +
	"\x13ChannelStartRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05token\x18\x02 \x01(\tR\x05token\"\x16\n" +
	"\x14ChannelStartResponse2\xa5\x01\n" +
	"\vSshxService\x12-\n" +
	...
	"\x05Close\x12\x12.sshx.CloseRequest\x1a\x13.sshx.CloseResponseB\tZ\a./protob\x06proto3"
...
var file_proto_sshx_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_proto_sshx_proto_goTypes = []any{
	...
	(*CliRequest)(nil),           // 13: sshx.CliRequest
	(*CliResponse)(nil),          // 14: sshx.CliResponse
	(*ChannelStartRequest)(nil),  // 15: sshx.ChannelStartRequest
	(*ChannelStartResponse)(nil), // 16: sshx.ChannelStartResponse
	nil,                          // 17: sshx.SequenceNumbers.MapEntry
	nil,                          // 18: sshx.SerializedSession.ShellsEntry
}
var file_proto_sshx_proto_depIdxs = []int32{
	17, // 0: sshx.SequenceNumbers.map:type_name -> sshx.SequenceNumbers.MapEntry
	...
	18, // 7: sshx.SerializedSession.shells:type_name -> sshx.SerializedSession.ShellsEntry
	3,  // 8: sshx.CliRequest.open_session:type_name -> sshx.OpenRequest
	9,  // 9: sshx.CliRequest.close_session:type_name -> sshx.CloseRequest
	15, // 10: sshx.CliRequest.start_channel:type_name -> sshx.ChannelStartRequest
	0,  // 11: sshx.CliRequest.terminal_data:type_name -> sshx.TerminalData
	6,  // 12: sshx.CliRequest.created_shell:type_name -> sshx.NewShell
	4,  // 13: sshx.CliResponse.open_session:type_name -> sshx.OpenResponse
	10, // 14: sshx.CliResponse.close_session:type_name -> sshx.CloseResponse
	16, // 15: sshx.CliResponse.start_channel:type_name -> sshx.ChannelStartResponse
	1,  // 16: sshx.CliResponse.terminal_input:type_name -> sshx.TerminalInput
	6,  // 17: sshx.CliResponse.create_shell:type_name -> sshx.NewShell
	5,  // 18: sshx.CliResponse.sync:type_name -> sshx.SequenceNumbers
	2,  // 19: sshx.CliResponse.resize:type_name -> sshx.TerminalSize
	12, // 20: sshx.SerializedSession.ShellsEntry.value:type_name -> sshx.SerializedShell
	3,  // 21: sshx.SshxService.Open:input_type -> sshx.OpenRequest
	7,  // 22: sshx.SshxService.Channel:input_type -> sshx.ClientUpdate
	9,  // 23: sshx.SshxService.Close:input_type -> sshx.CloseRequest
	4,  // 24: sshx.SshxService.Open:output_type -> sshx.OpenResponse
	8,  // 25: sshx.SshxService.Channel:output_type -> sshx.ServerUpdate
	10, // 26: sshx.SshxService.Close:output_type -> sshx.CloseResponse
...
func file_proto_sshx_proto_init() {
	...
	file_proto_sshx_proto_msgTypes[13].OneofWrappers = []any{
		(*CliRequest_OpenSession)(nil),
		(*CliRequest_CloseSession)(nil),
		(*CliRequest_StartChannel)(nil),
		(*CliRequest_TerminalData)(nil),
		(*CliRequest_CreatedShell)(nil),
		(*CliRequest_ClosedShell)(nil),
		(*CliRequest_Pong)(nil),
		(*CliRequest_Error)(nil),
	}
	file_proto_sshx_proto_msgTypes[14].OneofWrappers = []any{
		(*CliResponse_OpenSession)(nil),
		(*CliResponse_CloseSession)(nil),
		(*CliResponse_StartChannel)(nil),
		(*CliResponse_TerminalInput)(nil),
		(*CliResponse_CreateShell)(nil),
		(*CliResponse_CloseShell)(nil),
		(*CliResponse_Sync)(nil),
		(*CliResponse_Resize)(nil),
		(*CliResponse_Ping)(nil),
